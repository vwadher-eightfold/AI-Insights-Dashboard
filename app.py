...
print("✅ openai_key written to .streamlit/secrets.toml")
...
# Load CSV from Google Drive link (public)
...
# Since pend_rate_values isn't filtered yet, let's get corresponding pend rates
pend_rate_chart = [
